...
export default function CareerPage() {
  ...
  const careerTools = [
    ...
    },
    {
      ...
      desc: 'Take skill assessments to identify strengths and gaps in your developer toolkit.',
      link: '/achievements',
      cta: 'Assess Skills',
    },
  ];
  ...
  const jobListings = [
    { title: 'Junior Frontend Developer', company: 'TechStart', location: 'Remote', salary: 'R180k–R240k', tags: ['React', 'TypeScript', 'CSS'] },
    { title: 'Backend Engineer', company: 'CloudPeak', location: 'Cape Town', salary: 'R350k–R500k', tags: ['Node.js', 'PostgreSQL', 'AWS'] },
    { title: 'Full-Stack Developer', company: 'DevHub', location: 'Remote', salary: 'R300k–R450k', tags: ['React', 'Express', 'MongoDB'] },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-white">Featured Job Listings</h2>
          ...
          <div className="space-y-4">
            {jobListings.map((job) => (
              <div
                key={job.title}
                className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-white/20 transition flex flex-col md:flex-row md:items-center justify-between gap-4"
              >
                <div>
                ...
                <div className="text-right">
                  <div className="text-sm font-medium text-[#00d4ff]">{job.salary}</div>
                  <button className="mt-2 px-4 py-2 bg-white/5 border border-white/10 text-white rounded-lg text-sm hover:bg-white/10 transition">
                    Apply →
                  </button>
                </div>
              </div>
