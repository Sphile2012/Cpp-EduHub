...
function NavBar() {
  ...
  const navLinks = [
    ...
    { label: 'Infinity AI', path: '/ai-tutor' },
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? 'bg-[#0a0a0f]/95 backdrop-blur-md border-b border-white/5 py-2'
          : 'bg-transparent py-4'
      }`}
    >
          ...
          <div className="hidden lg:flex items-center gap-3">
            {user ? (
              <>
                ...
                <Link
                  to="/dashboard"
                  className="px-4 py-2 text-sm bg-gradient-to-r from-[#00d4ff] to-[#7c3aed] text-white rounded-lg font-medium hover:opacity-90 transition"
                >
                  Dashboard
                </Link>
                <button
        ...
        {mobileOpen && (
          <div className="lg:hidden mt-4 pb-4 space-y-1">
            ...
            <div className="pt-3 border-t border-white/5 space-y-1">
              {user ? (
                <>
                  <Link to="/profile" onClick={() => setMobileOpen(false)} className="block px-3 py-2 text-sm text-gray-300 hover:text-white">
                    Profile
                  </Link>
                  <Link to="/settings" onClick={() => setMobileOpen(false)} className="block px-3 py-2 text-sm text-gray-300 hover:text-white">
                    Settings
                  </Link>
                  <button onClick={logout} className="block w-full text-left px-3 py-2 text-sm text-gray-300 hover:text-white">
                    Logout
                  </button>
                </>
              ) : (
                <>
                  <Link to="/login" onClick={() => setMobileOpen(false)} className="block px-3 py-2 text-sm text-gray-300 hover:text-white">
                    Login
                  </Link>
                  <Link to="/signup" onClick={() => setMobileOpen(false)} className="block px-3 py-2 text-sm bg-gradient-to-r from-[#00d4ff] to-[#7c3aed] text-white rounded-lg font-medium text-center">
                    Sign Up
                  </Link>
                </>
              )}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full text-xs text-gray-400 mb-6">
              ...
              Now supporting 10+ programming languages
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link
                to="/signup"
                className="px-6 py-3 bg-gradient-to-r from-[#00d4ff] to-[#7c3aed] text-white rounded-xl font-semibold hover:opacity-90 transition shadow-lg shadow-[#00d4ff]/20"
              >
                Start Coding
              </Link>
              <Link
...
function StatsSection() {
  const stats = [
    ...
    { value: '100+', label: 'Learning Lessons' },
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          {stats.map((stat) => (
            <div key={stat.label} className="text-center">
              <div className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-[#00d4ff] to-[#7c3aed] bg-clip-text text-transparent mb-1">
                {stat.value}
              </div>
...
function FeaturesSection() {
  const features = [
    ...
    {
      title: 'Real Projects',
      desc: 'Build real-world projects and showcase them in your developer portfolio.',
      link: '/projects',
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <Link
              to="/playground"
              className="inline-block px-6 py-3 bg-gradient-to-r from-[#00d4ff] to-[#7c3aed] text-white rounded-xl font-semibold hover:opacity-90 transition"
            >
              Open Code Studio
            </Link>
          </div>
    ...
    <section className="py-20 bg-[#0d0d1a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-8">
          <Link
            to="/challenges"
            className="inline-block px-6 py-3 bg-white/5 border border-white/10 text-white rounded-xl font-semibold hover:bg-white/10 transition"
          >
            View All Challenges
          </Link>
        </div>
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-[#0a0a0f] via-[#0d0d1a] to-[#0a0a0f]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <Link
          to="/signup"
          className="inline-block px-8 py-4 bg-gradient-to-r from-[#00d4ff] to-[#7c3aed] text-white rounded-xl font-bold text-lg hover:opacity-90 transition shadow-lg shadow-[#00d4ff]/20"
        >
          Start Coding
        </Link>
      </div>
